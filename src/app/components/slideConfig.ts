...
export const slides: SlideConfig[] = [
  // ── SLIDE 1: Welcome ──
  {
    ...
    bottom: {
      ...
      heroText: "WHICH DRIVER OF THE NEW AMERICAN DREAM SHAPES THE FUTURE?",
  ...
  // ── SLIDE 3: Q2 — Lifemaxxing ──
  {
    ...
    bottom: {
      ...
      heroText: "WHICH DRIVER OF LIFEMAXXING SHAPES THE FUTURE?",
      heroSize: 3.5,
      showGraph: true,
      graphHue: 33,
      answers: [
  ...
  // ── SLIDE 4: Q3 — The Non-Invasive Age ──
  {
    ...
    bottom: {
      ...
      heroText: "WHICH DRIVER OF THE NON-INVASIVE AGE SHAPES THE FUTURE?",
      heroSize: 3.5,
      showGraph: true,
      graphHue: 155,
      answers: [
  ...
  // ── SLIDE 5: Q4 — Techno-Social Tug-of-War ──
  {
    ...
    bottom: {
      ...
      heroText: "WHICH DRIVER OF THE TECHNO-SOCIAL TUG-OF-WAR SHAPES THE FUTURE?",
      heroSize: 3.5,
      showGraph: true,
      graphHue: 305,
      answers: [
